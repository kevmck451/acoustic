...
if __name__ == '__main__':
    ...
    input_path = base_path + '/Experiments/Static Tests/Static Test 3/Data/Audio/4 channel'
    output_path = base_path + '/Experiments/Static Tests/Static Test 3/Data/Audio'
