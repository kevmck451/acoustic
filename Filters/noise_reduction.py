...
def noise_reduction_filter(audio_object, noise_audio_object, std_threshold=2):
...
if __name__ == '__main__':
    ...
    filepath_noise = '/Users/KevMcK/Dropbox/2 Work/1 Optics Lab/1 Acoustic/Data/Angel Noise Red/profiles/angel_noise.wav'
    angel_noise = Audio(filepath=filepath, num_channels=4)

    filtered_data = noise_reduction_filter(audio, angel_noise)
