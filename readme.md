...
3. (Optional) You can now navigate to each directory to find detailed README files on specific functionalities.

## Contributions

Contributions are always welcome! Please read the CONTRIBUTING.md file for guidelines.
