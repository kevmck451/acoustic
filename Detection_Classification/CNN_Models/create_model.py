...
# Deep CNN: 8 layers-Relu
def deep_model_3(features, labels, **kwargs):
    ...
    model.add(Conv2D(32, (3, 3), activation='relu', input_shape=input_shape, kernel_regularizer=l2(l2_value)))
    model.add(BatchNormalization())
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_regularizer=l2(l2_value)))
    model.add(BatchNormalization())
    model.add(MaxPooling2D((2, 2)))
    model.add(Dropout(0.3))
    ...
    # Dense Layer 1
    model.add(Dense(512, activation='relu', kernel_regularizer=l2(l2_value)))
    model.add(BatchNormalization())
    model.add(Dropout(0.6))
