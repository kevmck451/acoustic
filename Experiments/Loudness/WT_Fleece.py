...
'''
I want it to open every experiment sample as audio object
    - it needs to know which samples go with which experiment
    - it needs to the know the mic position for each experiment

- Average RMS value for each position in the mount
- Average RMS value for front mics vs back mics
- Average RMS value for each mic with and without fleece
